...
//   dic.setAttribute("style","margin : 10px");
  pe.innerHTML = `ID: ${prod.productId} <br>	//ใน tag ชื่อ p ตัวแปร pe ให้แสดงข้อความ ID: Id ของ  Obj products แล้วขึ้นบรรทัดใหม่
  Name: ${prod.productName} <br>		//ให้แสดงข้อความ Name: ชื่อของ  Obj products แล้วขึ้นบรรทัดใหม่
  Description: ${prod.productDesc} <br>		//ให้แสดงข้อความ Description: คำอธิบายของ  Obj products แล้วขึ้นบรรทัดใหม่
  Price: ${prod.productPrice} <br>		//ให้แสดงข้อความ Price: ราคาของ  Obj products แล้วขึ้นบรรทัดใหม่
  Stock: ${prod.stock}`;			//ให้แสดงข้อความ Stock: จำนวนสินค้าของ  Obj products
